...
const CoursePage: React.FC = () => {
    useParams<{ courseid: string; }>(); // Use useParams to get route parameters
        ...
        <div className="course-page rel flex">
            <div className="course-info rel">
                <div className="tutor rel aic flex">
                    <div className="pic">
                        <img src={course.tutor.dp} className="bl" alt="Tutor DP" />
                    </div>
                    <div className="meta rel">
                        ...
                        <div className="section section-b rel">
                            ...
                            <div className="you-list rel">
                                <div className="you rel aic flex">
                                    <div className="pic">
                                        <img src="http://placeimg.com/100/100/people?guest-1" className="bl" alt="Guest 1" />
                                    </div>
                                    <div className="meta rel">
                                ...
                                <div className="you rel aic flex">
                                    <div className="pic">
                                        <img src="http://placeimg.com/100/100/people?guest-2" className="bl" alt="Guest 2" />
                                    </div>
                                    <div className="meta rel">
                                ...
                                <div className="you rel aic flex">
                                    <div className="pic">
                                        <img src="http://placeimg.com/100/100/people?guest-3" className="bl" alt="Guest 3" />
                                    </div>
                                    <div className="meta rel">
                                        <h2 className="s15 name fontb c333">Leila Jefferson</h2>
                                        <h2 className="s13 uname fontn c777">@leilaearns</h2>
                                ...
                                <div className="you rel aic flex">
                                    <div className="pic">
                                        <img src="http://placeimg.com/100/100/people?guest-4" className="bl" alt="Guest 4" />
                                    </div>
                                    <div className="meta rel">
                                        <h2 className="s15 name fontb c333">Leila Jefferson</h2>
                                        <h2 className="s13 uname fontn c777">@leilaearns</h2>
